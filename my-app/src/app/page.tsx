...
export default async function Home() {
  ...
  try {
    ...
    return (
      <main className={styles.main}>
        <head>
          ...
          <link
            rel="icon"
            href="https://cdn.discordapp.com/avatars/1059594156839809074/f2ed3c7590d834ed2d86912124c4ee1e.png?size=128"
          />
        </head>
        ...
        <Navbar>
          <NavLinks>
            ...
            <li>
              {" "}
              <a href="https://docs.skyndalex.xyz">
                {" "}
                Documentation [Soon]{" "}
              </a>{" "}
            </li>
            <li>
              {" "}
              <a href="https://status.skyndalex.xyz"> Status </a>{" "}
            </li>
            <li>
              {" "}
            ...
            <li>
              {" "}
              <Link href="http://localhost:3000/commands">
                {" "}
                Command list{" "}
              </Link>{" "}
            </li>
        ...
        <div className={styles2.container}>
          ...
          <AboutUsGrid>
            <div className={styles2["grid-item"]}>
              ...
              <GridItemDescription>
                {" "}
                With us you can sleep peacefully!{" "}
              </GridItemDescription>
            </div>
            <div className={styles2["grid-item"]}>
              ...
              <GridItemDescription>
                {" "}
                All our projects are published on github{" "}
              </GridItemDescription>
            </div>
            <div className={styles2["grid-item"]}>
              ...
              <GridItemDescription>
                {" "}
                We're working on making the bot 24/7, pretty much! It is
                possible to put the bot on your own server{" "}
              </GridItemDescription>
            </div>
          </AboutUsGrid>
        </div>
          ...
          <FeaturesGrid>
            <div className={styles3["grid-item"]}>
              ...
              <div className={styles3["grid-item-content"]}>
                <div className={styles3["grid-item-description"]}>
                  <FeatureGridItemDescription>
                    With embed builders you are able to create beautiful and
                    more readable ads with a simple configurator for buttons
                  </FeatureGridItemDescription>
                </div>
            ...
            <div className={styles3["grid-item"]}>
              ...
              <div className={styles3["grid-item-content"]}>
                <div className={styles3["grid-item-description"]}>
                  <FeatureGridItemDescription>
                    Integrate your server with Github. You can create a forum
                    channel with the latest events from your repository, or just
                    make classic notifications.
                  </FeatureGridItemDescription>
                </div>
            ...
            <div className={styles3["grid-item"]}>
              ...
              <div className={styles3["grid-item-content"]}>
                <div className={styles3["grid-item-description"]}>
                  <FeatureGridItemDescription>
                    Fully customize your server. You can create other bot, and
                    connect it to skyndalex client! [ONLY FOR REQUEST]
                  </FeatureGridItemDescription>
                </div>
    ...
    return (
      <FetchFailed>
        {" "}
        Failed to fetch data from API. Try refresh the page.{" "}
      </FetchFailed>
    );
  }
}
